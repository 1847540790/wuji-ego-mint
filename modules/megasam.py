...
_ROOT = Path(__file__).resolve().parent.parent          # camera_calibration/
_MEGASAM_ROOT = _ROOT / 'third_party' / 'mega-sam'     # camera_calibration/third_party/mega-sam/
...
if _modules_pkg is not None and hasattr(_modules_pkg, '__path__'):
    if _droid_modules_dir not in _modules_pkg.__path__:
